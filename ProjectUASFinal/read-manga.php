        ...
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                <ul class="navbar-list">
                    ...
                    <li class="navbar-item"><a href="manga.php" class="navbar-link" data-nav-link>Comic List</a></li>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-top">
                <a href="index.php#home" class="logo">Toon Clover</a>
                <ul class="footer-list">
                    <li><a href="index.phpl#home" class="footer-link">Home</a></li>
                    <li><a href="manga.php" class="footer-link">Comic List</a></li>
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 All right reserved. Made with HardWork By Our Team.</p>
            </div>
        </div>
    </footer>
