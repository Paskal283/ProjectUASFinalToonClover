...
<html>
<head>
    <title>Toon Clover - <?php echo ucfirst($userRole); ?> Dashboard</title>
    ...
    <div class="container">
        ...
        <nav>
            <ul>
                ...
                <?php endif; ?>
                <li><a href="manage_manga.php">Manage Comic</a></li>
        ...
        <h2>Overview</h2>
        <p>Use the navigation links above to manage <?php if ($userRole === 'admin'): ?>genres, view contact messages,<?php endif; ?>  comic, and chapters.</p>
