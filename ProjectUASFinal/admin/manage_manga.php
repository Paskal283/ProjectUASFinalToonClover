...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['manga_name'])) {
    ...
    try {
        ...
        $alertMessage = "Comic Added Successfully! Wait for Admin Approval.";
    } catch (PDOException $e) {
        // Check if the error is due to duplicate entry
        if ($e->errorInfo[1] == 1062) {
            // Set error alert message for duplicate manga name
            $alertMessage = "Error: Comic with the same name already exists!";
        } else {
...
<html>
<head>
    <title>Toon Clover - Manage Manga</title>
...
<body>
    <div class="container">
        ...
        <form action="manage_manga.php" method="post" enctype="multipart/form-data">
            <input type="text" name="manga_name" placeholder="Comic Name" required class="input-field">
        ...
        <?php if ($userRole == 'admin'): ?>
            ...
            <form action="manage_manga.php" method="post">
                <label for="manga_id">Select Comic:</label>
